...
> Mira Light: AI That Sees You 想做的，是一个会先看见你、再以刚刚好的方式回应你的桌面 AI 陪伴体。

## 一句话项目介绍

Mira Light: AI That Sees You 让 AI 从被动等待输入的聊天框，变成一个能够主动感知、理解互动语境，并通过灯光、方向、姿态与节奏表达回应的桌面陪伴体。
...
Mira Light: AI That Sees You 的价值，不在于“让一盏灯动起来”，而在于把 AI 的交互链路从：
...
Mira Light: AI That Sees You 想证明的也不是“AI 可以控制硬件”，而是：
...
Mira Light: AI That Sees You 在展位上的演示，不是简单地播放一套预设动作，而是一条清晰的交互曲线：
...
Mira Light: AI That Sees You 是一个原创项目。我们使用 AI 辅助工具提高调研、编码、文档整理和迭代效率，但项目的问题定义、产品方向、场景设计、系统架构、交互表达和最终实现选择都由团队主导完成。
